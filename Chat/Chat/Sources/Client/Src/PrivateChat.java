...
public class PrivateChat extends Frame implements CommonSettings,KeyListener,ActionListener
{
	PrivateChat(ChatClient Parent, String ToUserName)
	{
        ...
        public void windowClosing(WindowEvent evt) { ExitPrivateWindow(); chatclient.SentPrivateMessageToServer("STOPPRIVATE",UserName);}});	
	}	
    ...
    public void ExitPrivateWindow() {
    	chatclient.SentPrivateMessageToServer("STOPPRIVATE",UserName);
