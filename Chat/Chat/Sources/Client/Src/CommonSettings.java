...
public interface CommonSettings
{
	...
	public int TAPPANEL_HEIGHT				= 	300;
	public int TAPPANEL_CANVAS_WIDTH		= 	180;
	public int TAPPANEL_CANVAS_HEIGHT		= 	210;
	...
	public String PRODUCT_NAME					= "Welcome to our Chatting room";
	public String COMPANY_NAME					= "Gachon Univ-NWCorp";
}